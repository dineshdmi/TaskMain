...
import img02 from "../car_battery.jpg";
...
const blogData = [
...

  {
    ...
    imgUrl: img02,
    description:
      " A dead car battery can leave you stranded. Use jumper cables or a jump starter for a quick fix. Regular maintenance helps prevent such issues.",
    quote:
      "Voluptua dolore takimata dolor sadipscing nonumy consetetur et. Stet sed dolores dolores dolores dolores eos.",
  },
